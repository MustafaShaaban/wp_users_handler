		...
		public function enqueue_scripts() {
			...
			wp_localize_script( $this->plugin_name, 'pl_globals', array(
				...
				'pl_phrases' => array(
					...
					'pass_regex'       => __( "The password should be at least 8 characters long, use upper and lower case letters, numbers, and symbols like ! \" ? $ % ^ &.", "wp_users_handler" ),
					...
					'confirm_password' => __( "The password doesn't match.", "wp_users_handler" ),
					'confirm_email'    => __( "The E-mail doesn't match.", "wp_users_handler" ),
				)
			) );
		}
